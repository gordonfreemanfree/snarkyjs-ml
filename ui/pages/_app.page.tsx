...
export default function App(props: any) {
  ...
  const [layer1, setLayer1] = useState<Array<Field>>(Array<Field>)
  const [layer2, setLayer2] = useState<Array<Field>>(Array<Field>)
  ...
  useEffect(() => {
    ;(async () => {
      ...
      Field(0),
        ...
        // console.log("initializing inputImage...")
        // console.log("imageArray_0 is", imageArray_0)
        // await zkappWorkerClient.initInputImage({ selectedImage: imageArray_0 })
